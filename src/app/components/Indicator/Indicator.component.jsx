...
// Component: Indicator
//   Guidance: The Indicator component is a box that changes colour and displays a message depending on the outcome of a calculation.  accepts props which determine the background color
